...
plotConfigurations <- list(
   ...
   list(simulationDirectory, paste(sep="", simulationDirectory, "-Utilization.pdf"),
        "Provider's Perspective", list(seq(0,10,1)), NA, list(1,0),
        "scenarioNumberOfAttackersVariable", "controller.SystemAverageUtilization",
        "calcAppPoolElementSelectionPolicy", "attackerAttackInterval", "registrarMaxHandleResolutionRate",
         "", "", "", filter),
   ...
   list(simulationDirectory, paste(sep="", simulationDirectory, "-RefusedHandleResolutions.pdf"),
        ...
        "scenarioNumberOfAttackersVariable", "controller.RegistrarGlobalRefusedHandleResolutions",
        "calcAppPoolElementSelectionPolicy", "attackerAttackInterval", "registrarMaxHandleResolutionRate",
         "", "", "", filter),

   list(simulationDirectory, paste(sep="", simulationDirectory, "-RefusedEndpointUnreachables.pdf"),
        "User's Perspective", list(seq(0,10,1)), NA, list(1,1),
        "scenarioNumberOfAttackersVariable", "controller.RegistrarGlobalRefusedEndpointUnreachables",
        "calcAppPoolElementSelectionPolicy", "attackerAttackInterval", "registrarMaxHandleResolutionRate",
         "", "", "", filter)
)
