...
simulationConfigurations <- list(
   ...
   list("calcAppPoolElementServiceMinCapacityPerJob", 250000),   # !!!
   ...
   list("calcAppPoolElementSelectionPolicyLoadDegradation", 0.0, 0.01, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.4, 0.5, 0.625, 0.75, 1.0),   # !!!
   ...
   list("calcAppPoolUserServiceJobSizeVariable", 1e6 ,5e6, 1e7, 2.5e7),   # !!!
