...
plotConfigurations <- list(
   ...
   list(simulationDirectory, paste(sep="", simulationDirectory, "-Utilization.pdf"),
        ...
        "calcAppPoolElementServiceCapacityGamma.TruncNormal", "controller.SystemAverageUtilization",
   ...
   list(simulationDirectory, paste(sep="", simulationDirectory, "-HandlingSpeed.pdf"),
        "User's Perspective", NA, seq(0, 80, 10), list(0,0.5),
        "calcAppPoolElementServiceCapacityGamma.TruncNormal", "controller.SystemAverageHandlingSpeed",
        "calcAppPoolElementSelectionPolicy", "puToPERatio", "jsToSC",
        "", "", "", filter),

   list(simulationDirectory, paste(sep="", simulationDirectory, "-ProcessingSpeed.pdf"),
        "User's Perspective", NA, NA, list(0,1),
        "calcAppPoolElementServiceCapacityGamma.TruncNormal", "controller.SystemAverageProcessingSpeed",
        "calcAppPoolElementSelectionPolicy", "puToPERatio", "jsToSC",
        "", "", "", filter),
   list(simulationDirectory, paste(sep="", simulationDirectory, "-StartupDelay.pdf"),
        "User's Perspective", NA, NA, list(0,1),
        "calcAppPoolElementServiceCapacityGamma.TruncNormal", "controller.SystemAverageStartupDelay",
        "calcAppPoolElementSelectionPolicy", "puToPERatio", "jsToSC",
        "", "", "", filter),
   list(simulationDirectory, paste(sep="", simulationDirectory, "-QueuingDelay.pdf"),
        "User's Perspective", NA, NA, list(0,1),
        "calcAppPoolElementServiceCapacityGamma.TruncNormal", "controller.SystemAverageQueuingDelay",
        "calcAppPoolElementSelectionPolicy", "puToPERatio", "jsToSC",
        "", "", "", filter),

   list(simulationDirectory, paste(sep="", simulationDirectory, "-ASAPPackets.pdf"),
        "Provider's Perspective", NA, NA, list(1,1),
        "calcAppPoolElementServiceCapacityGamma.TruncNormal", "controller.TransportNodeGlobalASAPPackets",
        "calcAppPoolElementSelectionPolicy", "puToPERatio", "jsToSC",
        "", "", "", filter),
   list(simulationDirectory, paste(sep="", simulationDirectory, "-ENRPPackets.pdf"),
        "Provider's Perspective", NA, NA, list(1,1),
        "calcAppPoolElementServiceCapacityGamma.TruncNormal", "controller.TransportNodeGlobalENRPPackets",
        "calcAppPoolElementSelectionPolicy", "puToPERatio", "jsToSC",
        "", "", "", filter)
)
