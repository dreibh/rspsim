...
# ------ Plots --------------------------------------------------------------
filter <- TRUE # "data1$calcAppPoolElementServerRegistrationLife == 30"
...
plotConfigurations <- list(
   ...
   list(simulationDirectory, paste(sep="", simulationDirectory, "-Utilization.pdf"),
        ...
        "calcAppPoolElementSelectionPolicy", "calcAppPoolElementServerRegistrationLife", "attackerAttackInterval",
        "", "", "", filter),

   list(simulationDirectory, paste(sep="", simulationDirectory, "-HandlingSpeed.pdf"),
        "User's Perspective", list(seq(0,50,5)), list(seq(0,70,10)), list(1,1),
