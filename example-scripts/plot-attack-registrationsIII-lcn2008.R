# ###########################################################################
# Name:        plot-attack-registrationsIII.R
# Description:
# Revision:    $Id$
# ###########################################################################
...
# ------ Plots --------------------------------------------------------------
filter <- "(data1$registrarMaxBadPEReports == 3) & (data1$calcAppPoolElementSelectionPolicy != \"LeastUsedDegradation\")"
...
plotConfigurations <- list(
  ...
  list(simulationDirectory, paste(sep="", simulationDirectory, "-Utilization.pdf"),
   ...
   list(simulationDirectory, paste(sep="", simulationDirectory, "-IgnoredAppPackets.pdf"),
        ...
        "attackerAttackInterval", "attackerProcess.TotalAttackerIgnoredApplicationMessages",
        "calcAppPoolElementSelectionPolicy", "registrarMaxBadPEReports", "attackRandomizeIdentifier",
        "", "", "", filter)
)
