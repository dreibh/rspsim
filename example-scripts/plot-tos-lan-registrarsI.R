...
plotConfigurations <- list(
   ...
   list(simulationDirectory, paste(sep="", simulationDirectory, "-Utilization.pdf"),
        ...
        "calcAppPoolElementSelectionPolicy", "scenarioNetworkLANDelayVariable", "asapUseTakeoverSuggestion",
        "calcAppPoolElementStaticRegistrarList", "jsToSC"),
   ...
   list(simulationDirectory, paste(sep="", simulationDirectory, "-OwnedPoolElements.pdf"),
        ...
        "lan.registrarArray", "scenarioNetworkLANDelayVariable", "asapUseTakeoverSuggestion",
        "calcAppPoolElementStaticRegistrarList", "jsToSC", "",
