...
dataUtilisation   <- plotPEUtilisation("mec2-test/Results",   "MEC2-EC")
dataHandlingSpeed <- plotPUHandlingSpeed("mec2-test/Results", "MEC2-EC")
summary           <- computeDelays("mec2-test/Results",       "MEC2-EC")
