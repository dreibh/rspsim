...
systemSummary     <- systemSummaryTable("mec2-1hrO/Results",  "MEC2-1hrO")
dataUtilisation   <- plotPEUtilisation("mec2-1hrO/Results",   "MEC2-1hrO")
dataHandlingSpeed <- plotPUHandlingSpeed("mec2-1hrO/Results", "MEC2-1hrO")
summary           <- computeDelays("mec2-1hrO/Results",       "MEC2-1hrO")
