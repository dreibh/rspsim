...
systemSummary     <- systemSummaryTable("mec2-2hrP/Results",  "MEC2-2hrP")
dataUtilisation   <- plotPEUtilisation("mec2-2hrP/Results",   "MEC2-2hrP")
dataHandlingSpeed <- plotPUHandlingSpeed("mec2-2hrP/Results", "MEC2-2hrP")
summary           <- computeDelays("mec2-2hrP/Results",       "MEC2-2hrP")
