...
plotConfigurations <- list(
   ...
   list(simulationDirectory, paste(sep="", simulationDirectory, "-Utilization.pdf"),
        "Provider's Perspective", NA, list(seq(10,60,10)), list(1,0),
        "attackerAttackInterval", "controller.SystemAverageUtilization",
        "calcAppPoolElementSelectionPolicy", "attackReportUnreachableProbability", "registrarMaxHandleResolutionRate",
         "", "", "", filter),

   list(simulationDirectory, paste(sep="", simulationDirectory, "-HandlingSpeed.pdf"),
        "User's Perspective", NA, list(seq(0,90,10)), list(1,0),
   ...
   list(simulationDirectory, paste(sep="", simulationDirectory, "-RefusedHandleResolutions.pdf"),
        ...
        "attackerAttackInterval", "controller.RegistrarGlobalRefusedHandleResolutions",
        "calcAppPoolElementSelectionPolicy", "attackReportUnreachableProbability", "registrarMaxHandleResolutionRate",
         "", "", "", filter),

   list(simulationDirectory, paste(sep="", simulationDirectory, "-RefusedEndpointUnreachables.pdf"),
        "User's Perspective", NA, NA, list(1,1),
        "attackerAttackInterval", "controller.RegistrarGlobalRefusedEndpointUnreachables",
        "calcAppPoolElementSelectionPolicy", "attackReportUnreachableProbability", "registrarMaxHandleResolutionRate",
         "", "", "", filter)
)
