# ###########################################################################
# Name:        plot-lud-loaddegradationI.R
# Description:
# Revision:    $Id$
# ###########################################################################
...
# ------ Plotter Settings ---------------------------------------------------
simulationDirectory  <- "lud-loaddegradationI"
...
plotConfigurations <- list(
   ...
   list(simulationDirectory, paste(sep="", simulationDirectory, "-Utilization.pdf"),
        ...
        "calcAppPoolElementSelectionPolicyLoadDegradation", "controller.SystemAverageUtilization",
        "puToPERatio", "jsToSC", "scenarioNetworkLANDelayVariable"),

   list(simulationDirectory, paste(sep="", simulationDirectory, "-HandlingSpeed.pdf"),
        "User's Perspective", NA, NA, list(1,0),
        "calcAppPoolElementSelectionPolicyLoadDegradation", "controller.SystemAverageHandlingSpeed",
        "puToPERatio", "jsToSC", "scenarioNetworkLANDelayVariable"),
)
