...
# ====== Simulation Settings ================================================
simulationDirectory <- "lud-requestSizeI"
simulationRuns <- 24
...
simulationConfigurations <- list(
   ...
   list("scenarioNetworkLANDelayVariable", 0, 200, 500, 1000),
   ...
   list("calcAppPoolUserServiceJobSizeVariable", 2.5e5, 1e6, 1.75e6, 2.5e6, 5e6, 7.5e6, 1e7),   # !!!
