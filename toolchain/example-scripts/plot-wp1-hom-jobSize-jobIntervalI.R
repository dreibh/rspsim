# ###########################################################################
# Name:        plot-wp1-hom-jobSize-jobIntervalI
...
plotConfigurations <- list(
   ...
   list(simulationDirectory, paste(sep="", simulationDirectory, "-Utilization.pdf"),
        "Provider's Perspective", NA, seq(60, 85, 5), list(1,0),
        "jsToSC", "controller.SystemAverageUtilization",
        "calcAppPoolElementSelectionPolicy", "calcAppPoolUserServiceJobIntervalVariable", ""),
   list(simulationDirectory, paste(sep="", simulationDirectory, "-HandlingSpeed.pdf"),
        "User's Perspective", NA, seq(0, 100, 10), list(1,1),
