...
#    }
   ...
   cat(sep="", "gammaScenario.lan[*].registrarArray[*].registrarProcess.registrarMaxIncrement = ", registrarMaxIncrement, "\n", file=iniFile)
   cat(sep="", "gammaScenario.lan[*].registrarArray[*].registrarProcess.registrarUpdateLossProbability = ", registrarUpdateLossProbability, "\n", file=iniFile)
   cat(sep="", "gammaScenario.lan[*].registrarArray[*].registrarProcess.registrarMaxBadPEReports = ", registrarMaxBadPEReports, "\n", file=iniFile)
...
simCreatorSimulationBinary <- "rspsim5"
